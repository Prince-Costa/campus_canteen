...
$pdo_statement = DB::db_connection()->prepare("SELECT * FROM user_details ORDER BY id DESC");
        ...
        <?php
            ...
            <div class="card mt-3">
                <div class="card-header header-elements-inline">
                    ...
                    <a href="add_user.php" class="btn btn-info legitRipple">Add User</a>
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                    <div class="datatable-header">
                        <div id="DataTables_Table_0_filter" class="dataTables_filter">
                            <label><span>Filter:</span> <input type="search" class="" placeholder="Type to filter..." aria-controls="DataTables_Table_0"></label>
                        </div>
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="User Name: activate to sort column descending">User Name</th>
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td><?=$user['gender']?></td>
                        <td><span class="badge <?=$user['status']? 'badge-success' : 'badge-danger'?>"><?php echo $user['status']? 'Active' : 'Inactive'?></span></td>
                        <td class="text-center">
                            <div class="d-flex  ">
                                <a href="edit_user.php?id=<?=$user['id']?>" class="btn btn-info btn-sm">Edit</a>
                                <form method="post" action="UserController.php" onclick="return confirm('Are you sure you want to delete this user?')">
                                    <input type="hidden" name="id" value="<?=$user['id']?>">
                                    <input name="delete_record" type="submit" value="Delete" class="btn btn-danger btn-sm"/>
                                </form>
                            </div>
                        </td>
                    </tr>
