		...
		<div class="content-wrapper">
            ...
            <form method="get" action="CreateProductController.php">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="cost_price" class="form-control" placeholder="Enter product cost price...">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="price" class="form-control" placeholder="Enter product sell price...">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="url" name="image_URL" class="form-control" placeholder="Enter product image url...">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-2">Image alt<span class="text-danger">*</span></label>
                    <div class="col-lg-10">
                        <input type="text" name="image_alt" class="form-control" placeholder="Enter product image url...">
                    </div>
                </div>
                <!-- <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <div class="form-check form-check-switchery form-check-switchery-double">
                            <label class="form-check-label">
                                Enable
                                <input type="checkbox" name="e_sale" class="form-check-input-switchery" checked="Enable" data-fouc="" data-switchery="true" style="display: none;">
                                Disable
                            </label>
                        </div>
                    </div>
